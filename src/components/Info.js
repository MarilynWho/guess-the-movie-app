  ...
  return (
    <div data-test="component-info">
      <div class="info-page">
        ...
        <p>
          - For each correct answer, the player earns one point. Keep track of
          the points throughout the game.
        </p>
        <p>
          - At the end of the game, tally up the scores and determine the
          winner. The person with the most points will be crowned the "Movie
          Master" or given a title based on their score
        </p>
        <p>
          - Repeat the game with a different playlist of songs for a new
          challenge{" "}
        </p>
